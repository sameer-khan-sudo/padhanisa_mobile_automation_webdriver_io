...
class ClassicalFusionPage {




    // Locator for the Classical Studio header (using UiSelector properly)
    public get classicalFusionHeaderLocator() {
        return $('android=new UiSelector().description("Fusion")');
    }
    ...
    public songListLocator(songName: string): ChainablePromiseElement {
        return $(`android=new UiSelector().descriptionContains("${songName}")`)
    }


    // public get songListLocator(): ChainablePromiseElement {
...
export default new ClassicalFusionPage();