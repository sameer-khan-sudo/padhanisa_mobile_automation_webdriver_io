...
describe("🎯 Sing A Song", () => {
    ...
    it("➡️  Redirect to Sing A Song section", async () => {
    ...
    it.skip("▶️  Click on Sing button redirects to Premium Page", async () => {
    ...
    it.skip("▶️  Lyrics button redirects to Premium Page", async () => {
    ...
    it.skip("🔎 Start Class from Global Search redirects to Premium Page", async () => {
    ...
    it.skip("🔎 Search and Start Class redirects to Premium Page", async () => {
